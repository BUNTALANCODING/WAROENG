        ...
        <section>
            <div class="halamanutama">
                ...
                <div class="kotak_login">
                    ...
                    <form method="POST" action="ProsesLoginKaryawan.jsp">

                        <div>
                            <label class="form-label">Username</label>
                            <input type="text" class="form-control" placeholder="Username" name="usernamekaryawan"
                                required>
                        </div>
                        </br>
                        <div>
                            <label class="form-label">Password</label>
                            <input type="text" class="form-control" placeholder="Password" name="passwordkaryawan"
                                required>
                        </div>
                        </br>
